...
export class Ejercicio{
    BusquedaCorridas(descripcion,empresa="AEF"){
        let regreso=[];
        let Busqueda = corridasWeb.filter(posicion => posicion.empresa == empresa && posicion.descripcionEmpresa==descripcion);
        if(Busqueda == ''){
            console.error("No hay corridas disponibles");
        }else{
            Busqueda.forEach(posicion => {
                regreso.push({"NumeroCorrida":posicion.numeroCorrida,"Descripcion Servicio":posicion.descripcionServicio, "Empresa":posicion.empresa, "DescripcionEmpresa":posicion.descripcionEmpresa,"TienePromocion": posicion.listaDescuentos == '' ? false:true});
            });
        }
...
//console.log(BusquedaCorridas('19 - AUTOBUSES INTERESTATALES DE  MEXICO, S.A. DE C.V.','AIM'));